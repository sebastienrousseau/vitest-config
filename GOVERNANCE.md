...
This document describes how @sebastienrousseau/vitest-config is run: who decides what, how
...
@sebastienrousseau/vitest-config is **maintainer-led**. As of the current release line it has a single
