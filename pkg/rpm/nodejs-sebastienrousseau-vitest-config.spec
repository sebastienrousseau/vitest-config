...
%global npm_bare      vitest-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-vitest-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Vitest testing configuration adhering to modern 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/vitest-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/vitest-config is a shareable configuration preset with no runtime
